...
class CreateContractorsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contractors', function (Blueprint $table) {
            ...
            $table->date('Birthday');
            $table->integer('Tele1')->nullable(false)->unsigned;;
            $table->integer('Tele2')->default(null)->unsigned;;
            ...
            //$table->foreign('Pormoter_Id')->references('Pormoter_Id')->on('pormoters')->onDelete('cascade')->onUpdate('cascade');       
